...
public class MessageController extends AbstractController {
	...
	public ModelAndView broadcastMessageMembers() {
		...
		modelAndView.setViewName("message/administrator/broadcastMessageMembers");
		modelAndView.addObject("banner", this.configurationService.findAll().iterator().next().getBanner());
		modelAndView.addObject("systemName", this.configurationService.findAll().iterator().next().getSystemName());
		return modelAndView;
	}
	...
	public ModelAndView saveBroadcastMembers(@Valid final MessageForm messageForm, final BindingResult binding) {
		...
		if (binding.hasErrors()) {
			...
			try {
				...
				result = this.createEditModelAndViewMembers(messageForm, "message.commit.error");
				result.setViewName("message/administrator/broadcastMessageMembers");
			}
		result.addObject("banner", this.configurationService.findAll().iterator().next().getBanner());
		result.addObject("systemName", this.configurationService.findAll().iterator().next().getSystemName());
	...
	public ModelAndView broadcastMessageBrotherhoods() {
		...
		modelAndView.setViewName("message/administrator/broadcastMessageBrotherhoods");
		modelAndView.addObject("banner", this.configurationService.findAll().iterator().next().getBanner());
		modelAndView.addObject("systemName", this.configurationService.findAll().iterator().next().getSystemName());
		return modelAndView;
	}
	...
	public ModelAndView saveBroadcastBrotherhoods(@Valid final MessageForm messageForm, final BindingResult binding) {
		...
		if (binding.hasErrors()) {
			...
			try {
				...
				result = this.createEditModelAndViewBrotherhoods(messageForm, "message.commit.error");
				result.setViewName("message/administrator/broadcastMessageBrotherhoods");
			}
		result.addObject("banner", this.configurationService.findAll().iterator().next().getBanner());
		result.addObject("systemName", this.configurationService.findAll().iterator().next().getSystemName());
	...
	protected ModelAndView createEditModelAndViewMembers(final MessageForm messageForm) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndViewMembers(final MessageForm entityMessage, final String message) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndViewBrotherhoods(final MessageForm messageForm) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndViewBrotherhoods(final MessageForm entityMessage, final String message) {
		ModelAndView result;
		final Collection<Brotherhood> actors = this.brotherhoodService.findAll();
		final Collection<String> priorities = this.configurationService.findAll().iterator().next().getPriorities();
